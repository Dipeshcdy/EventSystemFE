            ...
            <div className="flex-grow flex items-center">
              <div className="text-center flex justify-center flex-col w-full">
                ...
                <ul className="mt-5 flex gap-5 justify-center">
                  ...
                  <li>
                    <a href="/about" className="transition-colors duration-300 text-deep-purple-50 hover:text-teal-300">
                      About Us
                    </a>
                  </li>
                  <li>
                    <a href="/contact" className="transition-colors duration-300 text-deep-purple-50 hover:text-teal-300">
                      Contact
                    </a>
                  </li>
                </ul>
