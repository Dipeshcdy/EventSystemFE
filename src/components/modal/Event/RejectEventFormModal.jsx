...
const RejectEventFormModal = ({
    ...
    const saveData = async (e) => {
        ...
        const payload = {
            ...
            status: "Rejected", // or "Approved", depending on context
            remarks: formData.remarks, // or any custom remarks
        };
...
export default RejectEventFormModal;
